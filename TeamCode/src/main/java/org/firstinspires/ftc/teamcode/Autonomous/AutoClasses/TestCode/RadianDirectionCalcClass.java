...
public class RadianDirectionCalcClass {
    ...
    double xPM = 2.2;
    double xDM = 5.9;
    public void DirectionCalc(double startpointx, double startpointy, double endpointx, double endpointy, double odoX, double odoY, double theta, double odoRadian){
        ...
        //Radian Code
        setpointAngle = Math.atan2(ysetpoint, xsetpoint);
        finalAngle = setpointAngle + odoRadian;
